...
public class ItemRegister {
    ...
    public static final Item RAVENSTONE_VIX_FLOPPY_DISK = new FloppyDiskSystem("Vix 1",new FabricItemSettings().maxCount(1));
    ...
    public static void Initialize() {
        ...
        Registry.register(Registries.ITEM, new Identifier("ravenstone","floppy_disk_vix"), RAVENSTONE_VIX_FLOPPY_DISK);
