...
public class Talon560Processor extends Item implements Processor {
    ...
    public Talon560Processor(Settings settings) {
        super(settings);
    }
    ...
    public void saveNBT(ItemStack stack) {
        stack.getOrCreateNbt().putBoolean("Stop",Stop);
    ...
    public void loadNBT(ItemStack stack) {
        Stop = stack.getOrCreateNbt().getBoolean("Stop");
