...
public class BlockRegister {
    ...
    public static final ModemBlock RAVEN_MODEM_BLOCK = new ModemBlock(FabricBlockSettings.of(Material.METAL).strength(2.0f).sounds(BlockSoundGroup.NETHERITE));
    public static final HarddriveBlock RAVEN_HARDDRIVE_BLOCK = new HarddriveBlock(FabricBlockSettings.of(Material.METAL).strength(2.0f).sounds(BlockSoundGroup.NETHERITE));
    ...
    public static void Initialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier("ravenstone", "modem"), new BlockItem(RAVEN_MODEM_BLOCK, new Item.Settings().group(ItemGroupRegister.ITEM_GROUP)));
        Registry.register(Registry.ITEM, new Identifier("ravenstone", "hard_drive"), new BlockItem(RAVEN_HARDDRIVE_BLOCK, new Item.Settings().group(ItemGroupRegister.ITEM_GROUP)));
